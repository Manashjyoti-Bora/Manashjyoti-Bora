...
<svg width="780" height="36" viewBox="0 0 780 36" xmlns="http://www.w3.org/2000/svg" style="max-width:100%">
  <style>
    @keyframes fly{0%{transform:translate(-80px,30px)}20%{transform:translate(200px,-8px)}50%{transform:translate(430px,12px)}80%{transform:translate(640px,-4px)}100%{transform:translate(900px,24px)}}
    .plane{animation:fly 12s linear infinite;transform-origin:center}
    @keyframes con{0%,40%{opacity:0}45%{opacity:.7}70%{opacity:.7}100%{opacity:0}}
    .trail{animation:fly 12s linear infinite,con 12s linear infinite;stroke:#fff;stroke-width:2;stroke-dasharray:4 6;fill:none;opacity:0}
  </style>
  <path class="trail" d="M0,30 Q200,0 400,20 T800,10"/>
  <g class="plane"><text x="-20" y="0" font-size="26">✈️</text></g>
</svg>
</div>
...
<p align="center">
  ...
  <sub style="color:#22c55e;font-weight:700;margin-left:4px">online</sub><svg width="22" height="22" viewBox="0 0 44 44" xmlns="http://www.w3.org/2000/svg" style="vertical-align:middle;margin-left:6px">
  <style>@keyframes donut{to{transform:rotate(360deg)}}.don{transform-origin:22px 22px;animation:donut 1.1s linear infinite}</style>
  <circle cx="22" cy="22" r="16" fill="none" stroke="#21262d" stroke-width="4"/>
  <circle class="don" cx="22" cy="22" r="16" fill="none" stroke="#00CED1" stroke-width="4" stroke-linecap="round" stroke-dasharray="40 100"/>
</svg><svg width="28" height="22" viewBox="0 0 28 22" xmlns="http://www.w3.org/2000/svg" style="vertical-align:middle;margin-left:8px">
  <style>
    @keyframes wb1{0%,100%{opacity:.4}50%{opacity:1}}
    @keyframes wb2{0%,100%{opacity:.4}50%{opacity:1}}
    @keyframes wb3{0%,100%{opacity:.4}50%{opacity:1}}
    .w1{fill:#22c55e;animation:wb1 1.2s infinite}
    .w2{fill:#22c55e;animation:wb2 1.2s infinite .2s}
    .w3{fill:#22c55e;animation:wb3 1.2s infinite .4s}
  </style>
  <circle cx="14" cy="18" r="2" fill="#22c55e"/>
  <path class="w3" d="M4,13 Q14,4 24,13" stroke="#22c55e" stroke-width="2.5" fill="none" stroke-linecap="round"/>
  <path class="w2" d="M7,16 Q14,9 21,16" stroke="#22c55e" stroke-width="2.5" fill="none" stroke-linecap="round"/>
  <path class="w1" d="M10,18 Q14,14 18,18" stroke="#22c55e" stroke-width="2.5" fill="none" stroke-linecap="round"/>
</svg>
...
---
<div align="center" aria-hidden="true">
<svg width="780" height="40" viewBox="0 0 780 40" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style="max-width:100%">
  <defs>
    <linearGradient id="waveG" x1="0" x2="1" y1="0" y2="0">
      <stop offset="0" stop-color="#8A2BE2"/><stop offset=".5" stop-color="#4169E1"/><stop offset="1" stop-color="#00CED1"/>
      <animate attributeName="x1" values="0;1;0" dur="6s" repeatCount="indefinite"/>
    </linearGradient>
  </defs>
  <path d="M0,20 Q130,0 260,20 T520,20 T780,20 V40 H0 Z" fill="url(#waveG)" opacity=".4">
    <animate attributeName="d" values="M0,20 Q130,0 260,20 T520,20 T780,20 V40 H0 Z;M0,20 Q130,40 260,20 T520,20 T780,20 V40 H0 Z;M0,20 Q130,0 260,20 T520,20 T780,20 V40 H0 Z" dur="4s" repeatCount="indefinite"/>
  </path>
  <path d="M0,25 Q130,10 260,25 T520,25 T780,25 V40 H0 Z" fill="url(#waveG)" opacity=".6">
    <animate attributeName="d" values="M0,25 Q130,10 260,25 T520,25 T780,25 V40 H0 Z;M0,25 Q130,40 260,25 T520,25 T780,25 V40 H0 Z;M0,25 Q130,10 260,25 T520,25 T780,25 V40 H0 Z" dur="5s" repeatCount="indefinite"/>
  </path>
</svg>
</div>
...
<div style="display:inline-block;background:#0b1021;border:2px solid #8A2BE2;border-radius:10px;padding:8px 22px;font:16px Fira Code,monospace;color:#fff;overflow:hidden;height:30px;width:320px;position:relative">
  <style>
    @keyframes slot{0%,15%{transform:translateY(0)}20%,35%{transform:translateY(-30px)}40%,55%{transform:translateY(-60px)}60%,75%{transform:translateY(-90px)}80%,95%{transform:translateY(-120px)}100%{transform:translateY(0)}}
    .sl{animation:slot 10s infinite;display:inline-block}
  </style>
  <span style="color:#00CED1">&gt;</span>
  <span class="sl">
    <span style="display:block;height:30px;line-height:30px">building secure web apps</span>
    <span style="display:block;height:30px;line-height:30px;color:#FF69B4">shipping clean code</span>
    <span style="display:block;height:30px;line-height:30px;color:#FFD700">debugging with chai ☕</span>
    <span style="display:block;height:30px;line-height:30px;color:#22c55e">open to opportunities</span>
    <span style="display:block;height:30px;line-height:30px;color:#00CED1">from Nagaon, Assam 🇮🇳</span>
  </span>
  <span style="display:inline-block;width:8px;height:16px;background:#00CED1;margin-left:4px;animation:blink2 1s steps(1) infinite;vertical-align:-2px"></span>
</div>
</div>
...
<svg width="320" height="320" viewBox="0 0 320 320" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="whg"><stop offset="0" stop-color="#8A2BE2"/><stop offset="1" stop-color="#4169E1"/></radialGradient>
  </defs>
  <style>
    @keyframes orR{to{transform:rotate(360deg)}}
    @keyframes orL{to{transform:rotate(-360deg)}}
    .oR{transform-origin:160px 160px;animation:orR 18s linear infinite}
    .oL{transform-origin:160px 160px;animation:orL 12s linear infinite}
    .orI{animation:orR 18s linear infinite;transform-origin:center}
    .orI2{animation:orL 12s linear infinite;transform-origin:center}
  </style>
  <circle cx="160" cy="160" r="40" fill="url(#whg)" opacity=".5"/>
  <circle cx="160" cy="160" r="70" fill="none" stroke="#8A2BE2" stroke-width="1" stroke-dasharray="3 5" opacity=".4"/>
  <circle cx="160" cy="160" r="110" fill="none" stroke="#4169E1" stroke-width="1" stroke-dasharray="2 6" opacity=".3"/>
  <circle cx="160" cy="160" r="140" fill="none" stroke="#00CED1" stroke-width="1" stroke-dasharray="1 7" opacity=".3"/>
  <text x="160" y="166" text-anchor="middle" font-size="22" font-weight="bold" fill="#fff" font-family="monospace">DEV</text>
<g class="oR"><text x="160.0" y="98.0" text-anchor="middle" font-size="22">⚛️</text><text x="220.62177826491072" y="133.0" text-anchor="middle" font-size="18">🟦</text><text x="220.62177826491072" y="203.0" text-anchor="middle" font-size="18">🐍</text><text x="160.0" y="238.0" text-anchor="middle" font-size="18">🍃</text><text x="99.37822173508928" y="203.0" text-anchor="middle" font-size="18">🟩</text><text x="99.3782217350893" y="133.0" text-anchor="middle" font-size="18">🐳</text></g><g class="oL"><text x="160.0" y="58.0" text-anchor="middle" font-size="22">🌐</text><text x="237.78174593052023" y="90.21825406947978" text-anchor="middle" font-size="22">🎨</text><text x="270.0" y="168.0" text-anchor="middle" font-size="22">☁️</text><text x="237.78174593052023" y="245.78174593052023" text-anchor="middle" font-size="22">🔷</text><text x="160.0" y="278.0" text-anchor="middle" font-size="22">🦓</text><text x="82.21825406947978" y="245.78174593052023" text-anchor="middle" font-size="22">🔥</text><text x="50.0" y="168.0" text-anchor="middle" font-size="22">📦</text><text x="82.21825406947976" y="90.21825406947978" text-anchor="middle" font-size="22">⚡</text></g><g class="oR"><text x="160.0" y="24.0" text-anchor="middle" font-size="9" font-weight="700" font-family="monospace" fill="#00CED1">JS</text><text x="242.28993532094626" y="50.73762078750735" text-anchor="middle" font-size="9" font-weight="700" font-family="monospace" fill="#00CED1">TS</text><text x="293.1479122813215" y="120.73762078750737" text-anchor="middle" font-size="9" font-weight="700" font-family="monospace" fill="#00CED1">JSX</text><text x="293.1479122813215" y="207.26237921249265" text-anchor="middle" font-size="9" font-weight="700" font-family="monospace" fill="#00CED1">CSS</text><text x="242.28993532094626" y="277.26237921249265" text-anchor="middle" font-size="9" font-weight="700" font-family="monospace" fill="#00CED1">HTML</text><text x="160.0" y="304.0" text-anchor="middle" font-size="9" font-weight="700" font-family="monospace" fill="#00CED1">SQL</text><text x="77.71006467905377" y="277.26237921249265" text-anchor="middle" font-size="9" font-weight="700" font-family="monospace" fill="#00CED1">API</text><text x="26.85208771867852" y="207.26237921249265" text-anchor="middle" font-size="9" font-weight="700" font-family="monospace" fill="#00CED1">GIT</text><text x="26.85208771867849" y="120.73762078750738" text-anchor="middle" font-size="9" font-weight="700" font-family="monospace" fill="#00CED1">CLI</text><text x="77.71006467905374" y="50.73762078750737" text-anchor="middle" font-size="9" font-weight="700" font-family="monospace" fill="#00CED1">REST</text></g></svg> <svg width="36"
...
<svg width="420" height="46" viewBox="0 0 420 46" xmlns="http://www.w3.org/2000/svg">
  <style>
    .bar{fill:#00CED1}
    @keyframes wf{0%,100%{height:6px;y:20}50%{height:36px;y:5}}
  </style><rect class="bar" x="4" y="9" width="4" height="29" rx="2" style="animation:wf 1.15s ease-in-out 0.31s infinite"/><rect class="bar" x="11" y="9" width="4" height="28" rx="2" style="animation:wf 1.31s ease-in-out 0.96s infinite"/><rect class="bar" x="18" y="16" width="4" height="15" rx="2" style="animation:wf 0.72s ease-in-out 0.28s infinite"/><rect class="bar" x="25" y="18" width="4" height="10" rx="2" style="animation:wf 0.75s ease-in-out 0.77s infinite"/><rect class="bar" x="32" y="15" width="4" height="17" rx="2" style="animation:wf 0.77s ease-in-out 0.64s infinite"/><rect class="bar" x="39" y="9" width="4" height="29" rx="2" style="animation:wf 0.7s ease-in-out 0.04s infinite"/><rect class="bar" x="46" y="15" width="4" height="16" rx="2" style="animation:wf 0.61s ease-in-out 0.73s infinite"/><rect class="bar" x="53" y="15" width="4" height="16" rx="2" style="animation:wf 0.67s ease-in-out 1.0s infinite"/><rect class="bar" x="60" y="17" width="4" height="12" rx="2" style="animation:wf 1.2s ease-in-out 0.99s infinite"/><rect class="bar" x="67" y="16" width="4" height="15" rx="2" style="animation:wf 0.81s ease-in-out 0.95s infinite"/><rect class="bar" x="74" y="10" width="4" height="26" rx="2" style="animation:wf 1.2s ease-in-out 0.58s infinite"/><rect class="bar" x="81" y="13" width="4" height="21" rx="2" style="animation:wf 1.14s ease-in-out 1.18s infinite"/><rect class="bar" x="88" y="14" width="4" height="19" rx="2" style="animation:wf 1.12s ease-in-out 0.77s infinite"/><rect class="bar" x="95" y="15" width="4" height="16" rx="2" style="animation:wf 1.24s ease-in-out 0.98s infinite"/><rect class="bar" x="102" y="8" width="4" height="31" rx="2" style="animation:wf 1.04s ease-in-out 0.83s infinite"/><rect class="bar" x="109" y="8" width="4" height="31" rx="2" style="animation:wf 0.95s ease-in-out 1.18s infinite"/><rect class="bar" x="116" y="16" width="4" height="14" rx="2" style="animation:wf 0.74s ease-in-out 0.53s infinite"/><rect class="bar" x="123" y="14" width="4" height="19" rx="2" style="animation:wf 0.88s ease-in-out 0.22s infinite"/><rect class="bar" x="130" y="13" width="4" height="20" rx="2" style="animation:wf 1.08s ease-in-out 0.55s infinite"/><rect class="bar" x="137" y="11" width="4" height="25" rx="2" style="animation:wf 1.06s ease-in-out 1.07s infinite"/><rect class="bar" x="144" y="16" width="4" height="14" rx="2" style="animation:wf 0.79s ease-in-out 0.28s infinite"/><rect class="bar" x="151" y="13" width="4" height="21" rx="2" style="animation:wf 0.7s ease-in-out 0.84s infinite"/><rect class="bar" x="158" y="13" width="4" height="20" rx="2" style="animation:wf 1.36s ease-in-out 0.78s infinite"/><rect class="bar" x="165" y="19" width="4" height="9" rx="2" style="animation:wf 0.94s ease-in-out 0.0s infinite"/><rect class="bar" x="172" y="8" width="4" height="30" rx="2" style="animation:wf 1.0s ease-in-out 0.27s infinite"/><rect class="bar" x="179" y="17" width="4" height="13" rx="2" style="animation:wf 1.11s ease-in-out 1.01s infinite"/><rect class="bar" x="186" y="15" width="4" height="16" rx="2" style="animation:wf 1.19s ease-in-out 0.88s infinite"/><rect class="bar" x="193" y="16" width="4" height="14" rx="2" style="animation:wf 1.24s ease-in-out 1.06s infinite"/><rect class="bar" x="200" y="11" width="4" height="24" rx="2" style="animation:wf 1.1s ease-in-out 0.85s infinite"/><rect class="bar" x="207" y="8" width="4" height="30" rx="2" style="animation:wf 0.71s ease-in-out 0.86s infinite"/><rect class="bar" x="214" y="16" width="4" height="14" rx="2" style="animation:wf 1.18s ease-in-out 0.72s infinite"/><rect class="bar" x="221" y="8" width="4" height="30" rx="2" style="animation:wf 0.63s ease-in-out 1.03s infinite"/><rect class="bar" x="228" y="8" width="4" height="31" rx="2" style="animation:wf 0.89s ease-in-out 0.71s infinite"/><rect class="bar" x="235" y="16" width="4" height="14" rx="2" style="animation:wf 0.75s ease-in-out 0.68s infinite"/><rect class="bar" x="242" y="18" width="4" height="11" rx="2" style="animation:wf 1.15s ease-in-out 0.2s infinite"/><rect class="bar" x="249" y="13" width="4" height="21" rx="2" style="animation:wf 0.73s ease-in-out 1.08s infinite"/><rect class="bar" x="256" y="11" width="4" height="25" rx="2" style="animation:wf 1.04s ease-in-out 0.77s infinite"/><rect class="bar" x="263" y="14" width="4" height="18" rx="2" style="animation:wf 1.38s ease-in-out 0.83s infinite"/><rect class="bar" x="270" y="17" width="4" height="12" rx="2" style="animation:wf 1.02s ease-in-out 0.77s infinite"/><rect class="bar" x="277" y="15" width="4" height="17" rx="2" style="animation:wf 0.7s ease-in-out 1.2s infinite"/><rect class="bar" x="284" y="8" width="4" height="30" rx="2" style="animation:wf 1.05s ease-in-out 1.09s infinite"/><rect class="bar" x="291" y="14" width="4" height="19" rx="2" style="animation:wf 0.98s ease-in-out 0.09s infinite"/><rect class="bar" x="298" y="14" width="4" height="18" rx="2" style="animation:wf 0.63s ease-in-out 1.02s infinite"/><rect class="bar" x="305" y="11" width="4" height="25" rx="2" style="animation:wf 1.0s ease-in-out 0.4s infinite"/><rect class="bar" x="312" y="9" width="4" height="29" rx="2" style="animation:wf 0.98s ease-in-out 0.62s infinite"/><rect class="bar" x="319" y="13" width="4" height="20" rx="2" style="animation:wf 1.24s ease-in-out 0.25s infinite"/><rect class="bar" x="326" y="8" width="4" height="31" rx="2" style="animation:wf 1.33s ease-in-out 0.6s infinite"/><rect class="bar" x="333" y="16" width="4" height="14" rx="2" style="animation:wf 0.94s ease-in-out 0.18s infinite"/><rect class="bar" x="340" y="14" width="4" height="19" rx="2" style="animation:wf 1.07s ease-in-out 0.31s infinite"/><rect class="bar" x="347" y="13" width="4" height="21" rx="2" style="animation:wf 1.07s ease-in-out 0.93s infinite"/><rect class="bar" x="354" y="19" width="4" height="9" rx="2" style="animation:wf 0.88s ease-in-out 0.24s infinite"/><rect class="bar" x="361" y="18" width="4" height="10" rx="2" style="animation:wf 0.97s ease-in-out 0.38s infinite"/><rect class="bar" x="368" y="19" width="4" height="8" rx="2" style="animation:wf 1.08s ease-in-out 0.91s infinite"/><rect class="bar" x="375" y="12" width="4" height="22" rx="2" style="animation:wf 0.85s ease-in-out 0.78s infinite"/><rect class="bar" x="382" y="14" width="4" height="18" rx="2" style="animation:wf 1.04s ease-in-out 0.58s infinite"/><rect class="bar" x="389" y="17" width="4" height="12" rx="2" style="animation:wf 1.02s ease-in-out 0.07s infinite"/><rect class="bar" x="396" y="14" width="4" height="19" rx="2" style="animation:wf 0.64s ease-in-out 0.18s infinite"/><rect class="bar" x="403" y="15" width="4" height="17" rx="2" style="animation:wf 0.77s ease-in-out 0.99s infinite"/><rect class="bar" x="410" y="14" width="4" height="19" rx="2" style="animation:wf 0.83s ease-in-out 0.72s infinite"/><rect class="bar" x="417" y="12" width="4" height="22" rx="2" style="animation:wf 0.89s ease-in-out 0.15s infinite"/></svg><br>
...
<p align="center">
<img width="200" src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" alt="octocat">
<img width="220" src="https://media.giphy.com/media/3oKIPtjElfqwMOTbH2/giphy.gif" alt="developer">
<img width="200" src="https://media.giphy.com/media/11KzOet1ElBDz2/giphy.gif" alt="cat coding">
</p>
<p align="center">
  ...
  <img width="220" src="https://media.giphy.com/media/11JTxkrmq4bGE0/giphy.gif" alt="code">
</p>
```text
  __  __                  _      ____                       _
...
<svg width="300" height="90" viewBox="0 0 300 90" xmlns="http://www.w3.org/2000/svg">
  <style>
    ...
    @keyframes beam{0%,100%{opacity:.3}50%{opacity:.8}}
    @keyframes abduct{0%{transform:translateY(40px);opacity:0}20%{opacity:1}50%{transform:translateY(-4px)}80%{opacity:1}100%{transform:translateY(-40px);opacity:0}}
    .ufo{animation:hov 2.5s ease-in-out infinite;transform-origin:center}
    .bm{animation:beam 2s ease-in-out infinite}
    .cow{animation:abduct 4s ease-in-out infinite}
  </style>
  <defs>
    <linearGradient id="ufoG" x1="0" x2="0" y1="0" y2="1"><stop offset="0" stop-color="#c0c0c0"/><stop offset="1" stop-color="#6e7681"/></linearGradient>
    <linearGradient id="beamG" x1="0" x2="0" y1="0" y2="1"><stop offset="0" stop-color="#00CED1" stop-opacity=".8"/><stop offset="1" stop-color="#00CED1" stop-opacity="0"/></linearGradient>
  </defs>
  <g class="ufo">
    <ellipse cx="150" cy="38" rx="60" ry="12" fill="url(#ufoG)"/>
    <ellipse cx="150" cy="32" rx="30" ry="14" fill="#8A2BE2" opacity=".85"/>
    <circle cx="128" cy="40" r="3" fill="#FFD700"><animate attributeName="fill" values="#FFD700;#ff006e;#FFD700" dur="1s" repeatCount="indefinite"/></circle>
    <circle cx="150" cy="42" r="3" fill="#FFD700"><animate attributeName="fill" values="#FFD700;#00CED1;#FFD700" dur="1.2s" repeatCount="indefinite"/></circle>
    <circle cx="172" cy="40" r="3" fill="#FFD700"><animate attributeName="fill" values="#FFD700;#22c55e;#FFD700" dur="0.8s" repeatCount="indefinite"/></circle>
  </g>
  <polygon class="bm" points="120,48 180,48 210,88 90,88" fill="url(#beamG)"/>
  <text class="cow" x="144" y="86" font-size="20">🐄</text>
</svg>
<br><sub style="color:#8b949e">easter egg: UFO abducting a cow 🐮🛸 (just for fun)</sub>
</p>
...
<div align="center" aria-hidden="true">
<svg width="780" height="120" viewBox="0 0 780 120" xmlns="http://www.w3.org/2000/svg" style="max-width:100%">
  <rect width="780" height="120" fill="#060913"/>
  <style>
    @keyframes fw1{0%{opacity:0;r:0;transform:translate(0,0)}20%{opacity:1}60%{opacity:1}100%{opacity:0;r:50}}
    @keyframes fw2{0%{opacity:0;r:0}25%{opacity:1}70%{opacity:1}100%{opacity:0;r:40}}
    .spark{fill:#fff}
  </style><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle class="spark" cx="150" cy="70" r="0" fill="#FF69B4" style="animation:fw1 2.4s ease-out 0s infinite;transform-origin:150px 70px"/><circle cx="150" cy="70" r="3" fill="#FF69B4" opacity=".9"><animate attributeName="opacity" values="0;1;0" dur="2.4s" begin="0s" repeatCount="indefinite"/></circle><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle class="spark" cx="380" cy="50" r="0" fill="#FFD700" style="animation:fw2 2.4s ease-out 1.3s infinite;transform-origin:380px 50px"/><circle cx="380" cy="50" r="3" fill="#FFD700" opacity=".9"><animate attributeName="opacity" values="0;1;0" dur="2.4s" begin="1.3s" repeatCount="indefinite"/></circle><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle class="spark" cx="600" cy="75" r="0" fill="#00CED1" style="animation:fw1 2.4s ease-out 2.6s infinite;transform-origin:600px 75px"/><circle cx="600" cy="75" r="3" fill="#00CED1" opacity=".9"><animate attributeName="opacity" values="0;1;0" dur="2.4s" begin="2.6s" repeatCount="indefinite"/></circle><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle class="spark" cx="260" cy="40" r="0" fill="#8A2BE2" style="animation:fw2 2.4s ease-out 3.9s infinite;transform-origin:260px 40px"/><circle cx="260" cy="40" r="3" fill="#8A2BE2" opacity=".9"><animate attributeName="opacity" values="0;1;0" dur="2.4s" begin="3.9s" repeatCount="indefinite"/></circle><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle class="spark" cx="520" cy="60" r="0" fill="#22c55e" style="animation:fw1 2.4s ease-out 5.1s infinite;transform-origin:520px 60px"/><circle cx="520" cy="60" r="3" fill="#22c55e" opacity=".9"><animate attributeName="opacity" values="0;1;0" dur="2.4s" begin="5.1s" repeatCount="indefinite"/></circle></svg>
<p style="font:11px monospace;color:#8b949e;margin:-4px 0 6px">🎆 Thanks for visiting! 🎆</p>
</div>
