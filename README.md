...
pie showData
    ...
    "Python" : 76.8
```
<sub>🤖 Regenerated from the live language API, 21 Sep 2026.</sub>
<!--LANG-PIE:END-->
...
|------------|----------|-------|-----------|
| [Manashjyoti-Bora](https://github.com/Manashjyoti-Bora/Manashjyoti-Bora) | Python | 0 ⭐ | 2026-09-21 |
...
<sub>🤖 Auto-updated 21 Sep 2026 08:09 UTC — [workflow](https://github.com/Manashjyoti-Bora/Manashjyoti-Bora/blob/main/.github/workflows/daily-update.yml)</sub>
<!--REPO-INDEX:END-->
