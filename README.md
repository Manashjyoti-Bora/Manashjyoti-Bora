...
pie showData
    ...
    "Python" : 76.8
```
<sub>🤖 Regenerated from the live language API, 23 Sep 2026.</sub>
<!--LANG-PIE:END-->
...
|------------|----------|-------|-----------|
| [Manashjyoti-Bora](https://github.com/Manashjyoti-Bora/Manashjyoti-Bora) | Python | 0 ⭐ | 2026-09-23 |
...
<sub>🤖 Auto-updated 23 Sep 2026 07:55 UTC — [workflow](https://github.com/Manashjyoti-Bora/Manashjyoti-Bora/blob/main/.github/workflows/daily-update.yml)</sub>
<!--REPO-INDEX:END-->
