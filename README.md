...
pie showData
    ...
    "TypeScript" : 62.5
```
<sub>🤖 Regenerated from the live language API, 04 Sep 2026.</sub>
<!--LANG-PIE:END-->
...
<!--REPO-INDEX:START-->
**5 public repos · 12 followers — table rebuilt from the live GitHub API.**

| Repository | Language | Stars | Last push |
|------------|----------|-------|-----------|
| [Manashjyoti-Bora](https://github.com/Manashjyoti-Bora/Manashjyoti-Bora) | Python | 0 ⭐ | 2026-09-04 |
